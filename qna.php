...
<body>
  ...
  include_once("php/theme.php");
  ?>
  <header class="container main-header" <?php AddThemeChangerStyle() ?>>
  ...
  <main>
    ...
    <section class="container" <?php AddThemeChangerStyle("#4b4b4b") ?>>
      <div class="row">
    ...
    <section class="container" <?php AddThemeChangerStyle() ?>>
      <div class="accordion">
        <div class="question" <?php AddThemeChangerStyle("#4b4b4b") ?>>Otázka 1</div>
        <div class="answer" <?php AddThemeChangerStyle("#535353") ?>>Odpoveď 1</div>
      </div>
      <div class="accordion">
        <div class="question" <?php AddThemeChangerStyle("#4b4b4b") ?>>Otázka 2</div>
        <div class="answer" <?php AddThemeChangerStyle("#535353") ?>>Odpoveď 2</div>
      </div>
      <div class="accordion">
        <div class="question" <?php AddThemeChangerStyle("#4b4b4b") ?>>Otázka 3</div>
        <div class="answer" <?php AddThemeChangerStyle("#535353") ?>>Odpoveď 3</div>
      </div>
    </section>
    </section>
    </div>
